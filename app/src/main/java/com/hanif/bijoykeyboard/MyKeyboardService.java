...
public class MyKeyboardService extends InputMethodService {
    ...
    private static final String[][] EMOJI_CATEGORIES = {
        ...
        {"🎉",
         ...
         "🎋","🎄","🎃","🎑","🎐","🎏","🎠","🎡","🎢","💈","🎪","🎭","🖼","🎨","🎬","🎤",
         "🎧","🎼","🎵","🎶","🎷","🎸","🎹","🎺","🎻","🪕","🥁","🪘","🎮","🕹","🎲","♟"},
        // পতাকা: বাংলাদেশ ও প্রতিবেশী দেশ, মধ্যপ্রাচ্য (প্রবাসী বাংলাদেশিদের কমন গন্তব্য),
        // পূর্ব/দক্ষিণ-পূর্ব এশিয়া, তারপর অন্যান্য বড় দেশ — সবশেষে কয়েকটা generic পতাকা
        {"🇧🇩",
         "🇧🇩","🇮🇳","🇵🇰","🇳🇵","🇧🇹","🇱🇰","🇲🇲","🇸🇦","🇦🇪","🇶🇦","🇰🇼","🇴🇲","🇧🇭","🇯🇴","🇱🇧","🇮🇶",
         "🇮🇷","🇹🇷","🇪🇬","🇲🇾","🇸🇬","🇮🇩","🇹🇭","🇻🇳","🇵🇭","🇯🇵","🇰🇷","🇨🇳","🇭🇰","🇦🇫","🇺🇸","🇬🇧",
         "🇨🇦","🇦🇺","🇩🇪","🇫🇷","🇮🇹","🇪🇸","🇳🇱","🇷🇺","🇧🇷","🇿🇦","🇳🇬","🇰🇪","🇺🇳","🏁","🚩","🏳️"},
        // পড়াশোনা/স্টেশনারি: বই-খাতা-কলম, জ্যামিতি ও বিজ্ঞান যন্ত্রপাতি (চাঁদা/সেট-স্কয়ারের
        // কাছাকাছি ইউনিকোড ইমোজি হলো 📐, আলাদা কোনো "protractor" ইমোজি Unicode-এ নেই),
        // মাইক্রোস্কোপ (অণুবীক্ষণ যন্ত্র), টেলিস্কোপ, স্কুল-ব্যাগ, অফিস/ফাইলিং জিনিস
        {"📚",
         "📚","📖","📕","📗","📘","📙","📔","📓","📒","📝","✏️","🖊️","🖋️","🖌️","🖍️","📐",
         "📏","🔬","🔭","🧮","🧪","🧫","⚗️","🧬","🎒","🏫","🎓","📊","📈","📉","📋","📌",
         "📍","📎","🖇️","✂️","🗂️","🗄️","📁","📂","📅","🗓️","⏰","🔖","🏷️","🧑‍🎓","👨‍🏫","👩‍🏫"},
